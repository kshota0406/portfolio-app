    ...
    components: {
      MuiButton: {
        styleOverrides: {
          ...
          containedPrimary: {
            '&:hover': {
              backgroundColor: mode === 'light' ? lightThemeColors.primary.dark : darkThemeColors.primary.dark,
            },
          },
          containedSecondary: {
            '&:hover': {
              backgroundColor: mode === 'light' ? lightThemeColors.secondary.dark : darkThemeColors.secondary.dark,
            },
          },
        },
      },

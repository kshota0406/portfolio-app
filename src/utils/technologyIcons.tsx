...
import {
  DiReact, DiJavascript1, DiHtml5, DiCss3, DiNodejsSmall, DiMongodb, 
  DiPostgresql, DiGit, DiDocker, DiNpm
} from 'react-icons/di';
import {
  SiTypescript, SiNextdotjs, SiExpress, SiTailwindcss, SiMui,
  SiSupabase, SiStripe, SiSocketdotio, SiExpo
} from 'react-icons/si';
import {
  Code as CodeIcon,
